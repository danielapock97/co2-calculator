...
@Component({
  ...
  templateUrl: './emissions-per-transportype-chart.component.html',
  styleUrls: ['./emissions-per-transportype-chart.component.css']
})
      ...
      datalabels: {
        formatter: function(value, context) {
          return Math.floor(value*100)/100 + ' co2e\n'
            + Math.floor(value/EmissionsPerTransportypeChartComponent.sumEmissions*100*100)/100 + '%'
        },
        anchor: 'end',
        align: 'top',
        color: 'black',
      ...
      allData => {
        ...
        this.transportsOfUser.forEach(
          userTransport => {
            ...
            EmissionsPerTransportypeChartComponent.sumEmissions += userTransport.calculatedEmissions.co2e as number;
          }
        )
