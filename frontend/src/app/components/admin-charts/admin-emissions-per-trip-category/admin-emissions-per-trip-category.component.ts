...
} from "../../charts/emissions-per-transportype-chart/emissions-per-transportype-chart.component";
...
} from "../admin-emissions-per-transportype-chart/admin-emissions-per-transportype-chart.component";

@Component({
  selector: 'app-admin-emissions-per-trip-category',
  templateUrl: './admin-emissions-per-trip-category.component.html',
  styleUrls: ['./admin-emissions-per-trip-category.component.css']
})
export class AdminEmissionsPerTripCategoryComponent {
    ...
    plugins: {
      ...
      datalabels: {
        formatter: function(value, context) {
          ...
          let label3 = Math.floor(value/AdminEmissionsPerTransportypeChartComponent.sumEmissions*100*100)/100 + '%'
